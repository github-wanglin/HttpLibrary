...
public class BIOServer implements Server {
    ...
    //接收数据处理业务逻辑
    private final BiFunction<Socket, byte[], byte[]> dataHandler;
    //任务线程池
    ...
    public BIOServer(int port, ReceiveRegister receiveRegister, SendRegister sendRegister, TcpServerFailCallback tcpServerFailCallback, BiFunction<Socket, byte[], byte[]> dataHandler) {
